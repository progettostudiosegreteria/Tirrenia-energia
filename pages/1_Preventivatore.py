...
if "listino" not in st.session_state:
    st.session_state.listino = {
        ...
        # GAS DOMESTICO
        "gas_fix_dom": 0.5100,
        "psbil_dom_unico": 0.4499,
        "gas_var_dom_spread": 0.0700,
        "gas_qvd_dom": 18.00,
        
        # GAS ALTRI USI
        "gas_fix_au": 0.5500,
        "psbil_au_unico": 0.4499,
        "gas_var_au_spread": 0.0650,
        "gas_qvd_au": 26.00
    }
...
# ==========================================
# 2. PANNELLO AMMINISTRATORE (AREA RISERVATA)
# ==========================================
...
if admin_pass == "lauri2026":
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown("### 💡 MODIFICA RAPIDA LISTINI")
...
# ==========================================
# 3. INTERFACCIA UTENTE E LOGICA DI CALCOLO
# ==========================================
            ...
            with st.spinner("L'AI sta analizzando i testi..."):
                try:
                    ...
                    response = client.models.generate_content(
                        ...
                        contents=[
                            genai.types.Part.from_bytes(data=bytes_data, mime_type=uploaded_file.type),
                            st.session_state.prompt_ai
                        ]
                    )
